...
app.config['MYSQL_USER'] = 'CRNgbc2Sss'
app.config['MYSQL_PASSWORD'] = 'nWcsAJEOZ6'
app.config['MYSQL_DB'] = 'CRNgbc2Sss'
...
def predict():
    ...
    cur.execute("INSERT INTO details VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,null,null)",(id1,mail,now,li[0],li[1],li[2],li[3],li[4],li[5],li[6],li[7],li[8],li[9]))
